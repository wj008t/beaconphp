    ...
    <div style="padding: 20px 0;">
        <form id="placeForm" action="/flow/main_{@$fid@}/edit_place" method="post" data-display-mode="2" yee-module="ajaxform validate">
            ...
            <div class="form-group">
                ...
                <div class="form-box"><input type="text" value="{@$row.state|html@}" name="state" data-val='{"r":true,"integer":true}' data-val-msg='{"r":"状态值必须填写","integer":"只能输入整数"}' class="form-inp text"></div>
            </div>
