...
<div id="createPlace" style="position: relative; height:100%;">
    <div style="padding: 20px 0;">
        <form id="placeForm" action="/flow/main_{@$fid@}/add_transition" method="post" data-display-mode="2" yee-module="ajaxform validate">
            ...
            <div class="form-group">
                ...
                <div class="form-box"><input type="text" name="url" data-val='{"r":true}' data-val-msg='{"r":"必须填写处理URL"}' class="form-inp text"></div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label class="form-label" style="width: 80px">超时条件:</label>
                <div class="form-box"><input type="text" name="timeoutCondition" data-val='{"r":true,"integer":true}' data-val-msg='{"r":"条件必须填写","integer":"条件必须是整数"}' class="form-inp number"/></div>
            </div>
...
<script>
    window.readyYeeDialog = function (assign, win, elem) {
        $('#placeForm').on('success', function (ev, ret) {
            elem && elem.emit('addTransition', ret.data);
